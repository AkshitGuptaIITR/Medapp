                          ...
                          itemBuilder: (context, index) {
                            return IntrinsicWidth(
                              child: Container(
                                  ...
                                  child: Text(
                                      hospitalData!["specialization"]![index] ??
                                          [],
                                      style: TextStyle(
                                          fontSize: 14,
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: ListView.builder(
                            scrollDirection: Axis.horizontal,
                            // physics: NeverScrollableScrollPhysics(),
                            itemCount: hospitalData!["diagnosis"].length ?? 0,
                            itemBuilder: (context, index) {
                              return IntrinsicWidth(
                                child: Container(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: ListView.builder(
                            scrollDirection: Axis.horizontal,
                            // physics: NeverScrollableScrollPhysics(),
                            itemCount: hospitalData!["specialists"].length ?? 0,
                            itemBuilder: (context, index) {
                              return IntrinsicWidth(
                                child: Container(
                                    margin: EdgeInsets.only(right: 16),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          hospitalData!["specialists"]![index]![
                                                  "name"] ??
                                              [],
                                          style: TextStyle(
                                              fontSize: 14,
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: ListView.builder(
                            scrollDirection: Axis.horizontal,
                            // physics: NeverScrollableScrollPhysics(),
                            itemCount: hospitalData!["facilities"].length ?? 0,
                            itemBuilder: (context, index) {
                              return IntrinsicWidth(
                                child: Container(
                                    margin: EdgeInsets.only(right: 16),
